    ...
    <>
      ...
      <section className="bg-white py-20">
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
          <div>
            ...
            <h2 className="mt-2 text-3xl font-extrabold text-ink sm:text-4xl">Reliability</h2>
            ...
            <h3 className="mt-8 text-lg font-bold uppercase text-ink">HVAC Importance</h3>
      ...
      <section className="bg-[#f6f6f6] py-20">
        <div className="mx-auto max-w-3xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <h2 className="mt-2 text-3xl font-extrabold text-ink sm:text-4xl">Find Your Fit</h2>
          <p className="mt-5 text-base leading-relaxed text-muted">
