      ...
      <section className="bg-[#f6f6f6] py-20">
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
          ...
          <div>
            ...
            <h2 className="mt-2 text-3xl font-extrabold text-ink sm:text-4xl">Building for the Future</h2>
            <p className="mt-5 text-base leading-relaxed text-muted">
      ...
      <section className="bg-[#f6f6f6] py-20">
        <div className="mx-auto grid max-w-6xl items-center gap-12 px-4 sm:px-6 lg:grid-cols-[0.8fr_1fr] lg:px-8">
          ...
          <div>
            ...
            <h2 className="mt-2 text-3xl font-extrabold text-ink sm:text-4xl">Download FREE eBook</h2>
            <p className="mt-5 text-base leading-relaxed text-muted">
