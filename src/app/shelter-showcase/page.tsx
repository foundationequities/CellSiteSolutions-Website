...
function ProjectCard({ p }: { p: Project }) {
  return (
    <div className="flex flex-col rounded-lg border border-border bg-white p-6 shadow-sm transition-shadow duration-300 hover:shadow-lg">
      <p className="text-xs font-semibold uppercase tracking-wide text-muted">
        Customer: {p.customer}
      </p>
      <h4 className="mt-1 text-xl text-ink">{p.type}</h4>
      ...
      <section className="bg-white py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-2 text-[32px] text-ink sm:text-[40px]">Project Gallery</h2>
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {gallery.map((g) => (
              <div key={g.img} className="group relative aspect-[4/3] overflow-hidden rounded-lg">
                <Image
                  src={`${IMG}/${g.img}`}
                  alt={g.alt}
                  fill
