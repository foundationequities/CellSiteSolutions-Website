...
const gallery = [
  { img: "2025/04/2036-Exterior-side.jpg", alt: "Remanufactured telecom shelter exterior" },
  { img: "2025/04/2036-Exterior-HVAC_door.jpg", alt: "Telecom shelter exterior with HVAC and entry door" },
  { img: "2025/04/2036-Interior-panels_cabinets.jpg", alt: "Shelter interior electrical panels and cabinets" },
  { img: "2025/04/2036-Interior-wall1.jpg", alt: "Shelter interior wall and cable management" },
  { img: "2025/04/iHeartmedia_exteriorwalls.jpg", alt: "Telecom shelter exterior walls" },
  { img: "2025/04/iHeartMedia_DoorEntrance.jpg", alt: "Telecom shelter door entrance" },
  { img: "2025/05/Exterior-HVAC-wall_2_NOLABELS.jpg", alt: "Shelter exterior HVAC wall" },
  { img: "2025/03/rear_wHVACs.jpg", alt: "Shelter rear elevation with HVAC units" },
  { img: "2025/04/Exterior-HVAC-wall-2.jpg", alt: "Shelter exterior HVAC wall detail" },
];
...
function ProjectCard({ p }: { p: Project }) {
  return (
    <div className="flex flex-col rounded-lg border border-border bg-white p-6 shadow-sm">
      ...
      <h4 className="mt-1 text-lg font-bold text-ink">{p.type}</h4>
      <p className="mt-1 text-sm font-bold uppercase tracking-wide text-brand">{p.size}</p>
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl">
        ...
        <h2 className="mt-2 text-3xl font-extrabold uppercase text-ink sm:text-4xl">{title}</h2>
  ...
  return (
    <>
      ...
      <section className="bg-white py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <p className="text-sm font-bold uppercase tracking-[0.2em] text-brand">Our Work</p>
            <h2 className="mt-2 text-3xl font-extrabold text-ink sm:text-4xl">Project Gallery</h2>
            <p className="mt-5 text-base leading-relaxed text-muted">
              Real-world examples of past projects and installations that highlight our craftsmanship,
              attention to detail, and ability to deliver shelters that meet a wide range of customer
              requirements.
            </p>
          </div>
          <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {gallery.map((g) => (
              <div key={g.img} className="relative aspect-[4/3] overflow-hidden rounded-lg">
                <Image
                  src={`${IMG}/${g.img}`}
                  alt={g.alt}
                  fill
