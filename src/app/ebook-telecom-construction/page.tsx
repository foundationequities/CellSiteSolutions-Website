    ...
    <>
      ...
      <section className="bg-white py-20">
        <div className="mx-auto grid max-w-7xl items-start gap-12 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
          {/* eBook cover */}
          <div className="relative mx-auto aspect-[3/4] w-full max-w-sm overflow-hidden rounded-lg shadow-xl">
            <Image
          ...
          {/* Description + form */}
          <div>
            <p className="text-sm font-bold uppercase tracking-[0.2em] text-brand">Free eBook</p>
            ...
            <div className="mt-8 rounded-lg border border-border bg-[#f9f9f9] p-6 sm:p-8">
              <h3 className="text-lg font-bold uppercase text-ink">What does this eBook include?</h3>
