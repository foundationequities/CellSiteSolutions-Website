      ...
      <section className="bg-white py-20">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 rounded-lg border border-border bg-[#f9f9f9] p-6">
            <h3 className="text-lg font-bold text-ink">Missed the sale? Let&rsquo;s still connect.</h3>
      ...
      <section className="bg-[#f6f6f6] py-20">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <p className="text-sm font-bold uppercase tracking-[0.2em] text-brand">Discounted Options</p>
            <h2 className="mt-2 text-3xl font-extrabold text-ink sm:text-4xl">Choose Your Fit</h2>
          </div>
          <div className="mt-12 grid gap-8 md:grid-cols-2">
            <div className="rounded-lg border border-border bg-white p-8 shadow-sm">
              <h3 className="text-xl font-bold uppercase text-ink">
                DIY Shelter — $14,000 or $15,000
              </h3>
            ...
            <div className="rounded-lg border border-border bg-white p-8 shadow-sm">
              <h3 className="text-xl font-bold uppercase text-ink">
                Remanufactured Shelter — SAVE $6,000 or $7,000
              </h3>
              <p className="mt-4 text-sm leading-relaxed text-muted">
      ...
      <section className="bg-white py-20">
        <div className="mx-auto grid max-w-7xl gap-12 px-4 sm:px-6 lg:grid-cols-[1fr_1.2fr] lg:px-8">
          <div>
            ...
            <p className="mt-3 text-sm font-bold uppercase tracking-wide text-brand">
              Call +1 855 CEL SITE
            </p>
            <p className="mt-5 text-base leading-relaxed text-muted">
